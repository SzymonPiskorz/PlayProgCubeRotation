#include "Matrix3.h"
	...
	Matrix3 Matrix3::Translate(float dx, float dy) const
	{
		Matrix3 answer;
		answer.A11 = 1;
		answer.A12 = 0;
	...
	Matrix3 Matrix3::RotationX(float _angle) const
	{
		double radians = PI / 180 * _angle;
		Matrix3 answer;
		answer.A11 = 1;
	...
	Matrix3 Matrix3::RotationY(float _angle) const
	{
		double radians = PI / 180 * _angle;
		Matrix3 answer;
		answer.A11 = cos(radians);
	 ...
	 Matrix3 Matrix3::RotationZ(float _angle) const
	{
		double radians = PI / 180 * _angle;
		Matrix3 answer;
		answer.A11 = cos(radians);
